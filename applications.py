...
# GOOGLE_API_KEY="AIzaSyAx7YtQWl5JZKwyXvQyALI9cjkX4VvrSFc"
...
# Funtion to get weather of a city
...
def get_weather(city:str)-> str:
    ...
    """
    try:
        api_key = "88eac28e2133900e97ffc7bbbaded1c7"
        url = f"https://api.openweathermap.org/data/2.5/weather?q={city}&appid={api_key}&units=metric"

        response = requests.get(url)
        response.raise_for_status()  # raises an error if status_code != 200
...
def get_news(topic: str):
    ...
    """
    try:
        api_key="6b3d75cdebcd44a0ba9e4a5559370b31"
...
def find_local_events(city: str):
    ...
    try:
        api_key="0b72f0d941f7b2a38cf780daabdd5f537e927ad485ec1c8520b2182c724df785"
...
print(find_local_events("Dehradun"))
